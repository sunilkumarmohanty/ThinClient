    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                LoginData loginData = new LoginData(mLogin, mPassword);
                RemoteAppsService remoteAppsService =
                        new RemoteAppsClient(getApplicationContext()).getRemoteAppsService();
                Call<ResponseBody> loginCall = remoteAppsService.login(loginData);
