...
//				}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            instance = extras.get(Constants.INSTANCE_ID).toString();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(getString(android.R.string.yes), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                // Shuts the server
                            stopServer(getApplicationContext(),instance);
    ...
    public void stopServer(final Context context, final String instance) {
        Log.d(TAG,"stopping instance :"+ instance);
        RemoteAppsService remoteAppsService =
                new RemoteAppsClient(context).getRemoteAppsService();
        Call<InstanceLaunchData> startInstanceCall = remoteAppsService.stopInstance(new Instance(instance));
        startInstanceCall.enqueue(new Callback<InstanceLaunchData>() {
            ...
            public void onResponse(Call<InstanceLaunchData> call, Response<InstanceLaunchData> response) {
                Log.d(TAG,"stopped instance :"+ response.body().toString());
                vncCanvas.vncConn.shutdown();
                finish();
            }
